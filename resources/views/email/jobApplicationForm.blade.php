                    ...
                    <tr> <!-- Masthead -->
                        <th class="small-12 large-12 columns first last">
                            <table>
                                <tr>
                                    <th>
                                        <h1 class="text-center">{{__("New Application Form Has Submitted")}}</h1>
                                        <center data-parsed="">
                                    ...
                                    <th>
                                        ...
                                        <!--[if mso]>
                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                         ...
                                                         href="{{route('careers.show',['vacancy'=>$vacancy->id])}}"
...
<![endif]-->
                                            <a href="{{route('careers.show',['vacancy'=>$vacancy->id])}}"
                            ...
                            <table>
                                <tr>
                                    <th>
                                        ...
                                        @foreach($applicant->attributesToArray() as $attr=>$value)
                                            @continue(in_array($attr,['id','created_at','updated_at','deleted_at','vacancy_id']))
                                            <p>
                                                <b>{{\Illuminate\Support\Str::title(str_replace('_',' ',$attr))}}:</b>
                                            </p>
                                            <p>{{$value}}</p>
                                        @endforeach
                                    </th>
                            ...
                            <table>
                                <tr>
                                    <th>
                                        ...
                                        <p>{{date('d.m.Y', strtotime($applicant->created_at))}}</p>
                                        <p>{{date('H:i:s', strtotime($applicant->created_at))}}</p>
                                    </th>
                                </tr>
                            </table>
                        </th>
