                            ...
                            <div class="row interval-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="intervals[0][start]" id="interval.start" value="0"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="intervals[0][end]" id="interval.end" value="0"
                                               min="0" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="intervals[0][rate]" id="interval.rate" value="0"
...
@push('style')
    <style>
        ...
        #add-interval-btn:hover, .remove-btn:hover {
            margin-left: -1px;
            margin-top: -1px;
            margin-bottom: -1px;
            width: 37px;
